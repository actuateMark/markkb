...
| actuate-filters | 2.0.4 | Detection filters (IOU, confidence, ignore zones, blacklist, stationary) |
...
| actuate-suddenscenechange | 2.3.2 | SIFT-based camera tampering/scene change detection |
| actuate-blur | 1.1.3 | FFT-based blur detection |
| actuate-imutils | 1.0.4 | OpenCV image processing utilities |
...
| Package | Version | Purpose |
|---------|---------|---------|
| actuate-integration-calls | -- | VMS API clients (Ajax, AutoPatrol, Avigilon, DW, Eagle Eye, Exacq, HikCentral, LISA, Milestone) |
| actuate-alarm-senders | -- | 25+ alert sender implementations |
| actuate-connector-observers | -- | Observer pattern (intruder, loiterer, line crossing, blacklist) |
...
| actuate-monitoring | 1.1.4 | Deployment health (New Relic, CloudWatch, Datadog) |
