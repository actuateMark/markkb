...
- **[[scene-change-detection|Scene change detection]]** -- identifying when a camera's field of view has shifted unexpectedly (configurable sensitivity: low/medium/high)
