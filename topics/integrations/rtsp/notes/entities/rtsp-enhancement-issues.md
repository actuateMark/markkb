...
| [#1649](https://github.com/aegissystems/vms-connector/issues/1649) | RTSP error code classification (401/403/453/461) | Tier 2 | 4-6 hrs | Open |
...
| [#1652](https://github.com/aegissystems/vms-connector/issues/1652) | Fix bare except: blocks in RTSP puller code | Tier 1 | 30 min | Open |
...
|-------------|-----------|-----------|
| Replace RTSPDiagnostics HTTP GET with TCP+RTSP DESCRIBE | [[chm-phase1-network-probe]] | Phase 1 core deliverable |
...
| [#1647](https://github.com/aegissystems/vms-connector/issues/1647) | HikCentral healthcheck NoneType | 167 |
