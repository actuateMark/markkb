...
**The knowledge base is now the team's, at `aegissystems/actuate-kb`** (private). ~1,070 notes on the platform, plus everything I know about our ops [[SETUP|setup]]. Open it in Obsidian, or just read the Markdown on GitHub.
...
- **§2 [[roadmaps|Roadmaps]]** — forward-looking overviews of the next high-leverage work:
...
1. **Pick the automation identity** (ENG-376, §A in `home/offboarding/manual-action-checklist`) — firebat's GitHub/[[new-relic|New Relic]]/Atlassian creds are still mine; the team needs to decide a machine/service identity so I can re-home them at handover.
...
4. **[[watchman-repo|Watchman]] walkthrough** (me + Mike + Paolo) before Friday — the irreplaceable part.
